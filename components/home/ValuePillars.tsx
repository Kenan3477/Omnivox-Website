...
const pillars = [
  ...
  {
    title: "Dial",
    description: "Manual, preview, progressive, and power from the browser. Review, skip, or stay on the line — AMD on paced modes.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: "Track usage",
    description: "~5p outbound / ~4p inbound. Digital is not in this wallet. Low-balance warnings on Work. Top up in Admin → Call Credits.",
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
