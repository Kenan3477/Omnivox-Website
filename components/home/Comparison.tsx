      ...
      <SectionContainer>
        <AnimateOnScroll>
          <SectionHeader
            ...
            description="You're choosing between paid platforms — CloudTalk, Connex, legacy diallers. Here's where OMNIVOX wins on price and transparency."
          />
        </AnimateOnScroll>

        <div className="grid gap-8 lg:grid-cols-2">
          <AnimateOnScroll>
            <div className="relative overflow-hidden rounded-3xl border-2 border-blue-200/60 bg-white p-8 md:p-10 shadow-card-hover h-full">
              <div className="absolute top-0 right-0 px-4 py-1.5 bg-blue-500 text-white text-xs font-bold uppercase tracking-wider rounded-bl-xl">
                OMNIVOX
              </div>
