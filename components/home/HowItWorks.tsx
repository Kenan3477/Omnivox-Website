        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {steps.map((step, i) => (
            <AnimateOnScroll key={step.n} delay={i * 80}>
              <div className="relative rounded-2xl border border-white/8 bg-white/[0.03] p-6 h-full hover:border-blue-500/20 transition-colors">
                <span className="font-display text-4xl font-bold text-blue-500/25">{step.n}</span>
