    ...
    content: (
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          <div className="flex-1 rounded-lg bg-blue-500 py-2 text-center text-sm font-semibold text-white">Dial</div>
    ...
    content: (
      <div className="space-y-3">
        <div className="rounded-lg bg-blue-50 border border-blue-100 p-4">
          <p className="text-xs text-blue-700 font-medium">Credit balance</p>
          <p className="text-2xl font-bold text-blue-800">£247.50</p>
        </div>
        {[
            ...
            <AnimateOnScroll key={mockup.title} delay={i * 100}>
              <div className="rounded-2xl border border-slate-200 bg-white overflow-hidden shadow-lg">
                <div className="bg-gradient-to-r from-slate-900 via-blue-950 to-purple-950 p-4">
                  ...
                  <p className="text-sm text-blue-200/70">{mockup.subtitle}</p>
                </div>
