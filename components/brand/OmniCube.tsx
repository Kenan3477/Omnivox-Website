  ...
  return (
    ...
    >
      ...
      <div className="omni-cube-scene relative h-28 w-28">
        ...
        <CubeFace className="omni-face-top bg-gradient-to-br from-indigo-400/30 to-indigo-600/20 backdrop-blur-sm border border-white/30 rounded-2xl shadow-2xl">
          <Icon type="cog" className="h-10 w-10" />
        </CubeFace>
        <CubeFace className="omni-face-bottom bg-gradient-to-br from-blue-400/25 to-indigo-600/20 backdrop-blur-sm border border-white/30 rounded-2xl shadow-2xl">
