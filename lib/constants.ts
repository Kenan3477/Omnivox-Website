export const siteConfig = {
  ...
  description:
    "OMNIVOX is a cloud dialer and agent workspace for UK/EU sales teams — manual and preview outbound, platform-managed telephony, and one prepaid credit wallet for all calls.",
...
export const faqItems = [
  {
    ...
    answer:
      "No. OMNIVOX includes platform-managed telephony. You buy prepaid call credits and dial — no carrier accounts or separate telecom bills.",
  },
  {
