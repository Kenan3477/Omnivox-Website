      ...
      <div className="mx-auto max-w-3xl px-4 md:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-10 text-slate-600 leading-relaxed">
          <section>
            ...
            <p className="mt-3">
              OMNIVOX is operated by {siteConfig.poweredBy} (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;).
              ...
              See our <Link href="/trust" className="text-blue-600 hover:text-blue-500">Trust page</Link> for how that works.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              This policy explains how we handle personal data when you visit our website, contact us, or use OMNIVOX as a customer.
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              omnivox.vercel.app has its own operational logs as described under account and technical data above.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Privacy enquiries:{" "}
              <a href={`mailto:${siteConfig.contactEmail}`} className="text-blue-600 hover:text-blue-500">{siteConfig.contactEmail}</a>.
              {" "}For platform compliance detail, see <Link href="/trust" className="text-blue-600 hover:text-blue-500">Trust &amp; Security</Link>.
            </p>
          </section>
        </div>
      </div>
