        ...
        <div className="mt-12 space-y-8 text-navy-600 leading-relaxed">
          <section>
            ...
            <p className="mt-3">
              ...
              See the <Link href="/privacy" className="text-blue-700 hover:text-blue-600">Privacy Policy</Link> and{" "}
              <Link href="/trust" className="text-blue-700 hover:text-blue-600">Trust page</Link> for data roles.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              OMNIVOX provides a cloud-based contact centre and outbound dialer including platform-managed telephony,
              ...
              <Link href="/features" className="text-blue-700 hover:text-blue-600">features page</Link>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <Link href="/pricing" className="text-blue-700 hover:text-blue-600">pricing page</Link>. Call credits are
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              recording consent laws, including PECR and TPS/CTPS where they apply. You must not use OMNIVOX for
          ...
          <section>
            ...
            <p className="mt-3">
              ...
              <a href="mailto:hello@omnivox.co.uk" className="text-blue-700 hover:text-blue-600">hello@omnivox.co.uk</a>{" "}
              or use the <Link href="/contact" className="text-blue-700 hover:text-blue-600">contact form</Link>.
            </p>
          </section>
        </div>
      </div>
