        ...
        <SectionContainer>
            <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-card">
              ...
              <table className="w-full text-left">
                <caption className="sr-only">OMNIVOX platform and telephony rates</caption>
                <thead>
              ...
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 flex flex-col justify-center">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  {siteConfig.topUpPacks.map((pack) => (
                    <span key={pack} className="rounded-2xl border border-blue-200 bg-white px-6 py-4 text-xl font-bold text-blue-800 shadow-sm">
                      £{pack}
                    </span>
                  ))}
                </div>
